...
export function LeadsIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function QuotationsIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function VehiclesIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 17H5a2 2 0 01-2-2V9a2 2 0 012-2h14a2 2 0 012 2v6a2 2 0 01-2 2h-3m-9 0a2 2 0 104 0m5 0a2 2 0 104 0M7 9l2-4h6l2 4" />
    </svg>
  );
}

export function CustomersIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function HelpIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function RupeeIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M7 3h10v2H7V3zm0 4h10v2H9.5c.5 1 .5 2 0 3H17v2H9.39l4.5 5.5-1.56 1.28L6.5 14H7v-2h2.5c1 0 1.5-.5 1.5-1s-.5-1-1.5-1H7V7z"/>
    </svg>
  );
}
...
export function ChartIcon({ className = 'w-16 h-16' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 64 64" stroke="currentColor" strokeWidth={1.5}>
      ...
      <rect x="50" y="32" width="10" height="24" rx="2" />
    </svg>
  );
}
