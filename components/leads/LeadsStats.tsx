  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6">
      <div className="bg-white rounded-xl border border-gray-100 p-4 md:p-5">
        ...
        <p className="text-3xl md:text-4xl font-bold text-gray-900">{totalLeads}</p>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 md:p-5">
        ...
        <p className="text-3xl md:text-4xl font-bold text-orange-500">{hotLeads}</p>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 md:p-5">
        ...
        <p className="text-3xl md:text-4xl font-bold text-indigo-600">{conversionRate}%</p>
      </div>

      <div className="bg-white rounded-xl border border-gray-100 p-4 md:p-5 flex items-center justify-center col-span-2 lg:col-span-1">
